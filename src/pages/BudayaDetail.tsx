...
const BudayaDetail = () => {
  const { id } = useParams();
  const item = budayaData.find(item => item.id === id);
    ...
    return (
      <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 py-20 text-center">
          <h1 className="text-4xl font-bold mb-4">Budaya tidak ditemukan</h1>
          <Button asChild>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <Button asChild variant="outline" className="mb-8">
            <Link to="/budaya" className="flex items-center space-x-2">
              <ArrowLeft size={16} />
              <span>Kembali ke Daftar Budaya</span>
            </Link>
          </Button>
